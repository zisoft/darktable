...
//  dt_gui_add_help_link(styles, "bottom_panel_styles");
  ...
  DT_CONTROL_SIGNAL_CONNECT(DT_SIGNAL_PRESETS_CHANGED, _export_presets_changed_callback, self);
}
...
void gui_cleanup(dt_lib_module_t *self)
{
  ...
  DT_CONTROL_SIGNAL_DISCONNECT(_export_presets_changed_callback, self);
